# Modified Composer template
1. Clone down repo
2. cd into project
3. lando start
4. lando composer install
5. cd into drupal install files (docroot, web etc)
6. lando drush si
7. change uuid on config files to match uuid of sit
8. config import

# Composer base template for Drupal projects
